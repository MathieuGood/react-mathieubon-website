		...
		<div
			...
			<div className="relative bg-white w-10/12 md:w-3/4 lg:w-3/4 max-w-[700px] max-h-screen p-6 rounded-lg shadow-lg overflow-y-auto">
				...
				<div className="flex justify-center mt-6 sticky bottom-0 bg-white py-4">
					<button
						onClick={onClose}
						className="inline-flex items-center justify-center px-8 py-2 mt-4 text-m font-medium text-center text-gray-900 border bg-green-light border-gray-200 rounded-lg hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 transition duration-300">
						Close
					</button>
				</div>
			</div>
