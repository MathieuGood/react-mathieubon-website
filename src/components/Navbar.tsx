...
const Navbar: React.FC = () => {
    ...
    return (
        <AppBar position="static">
            <Toolbar sx={{ backgroundColor: customColors.primaryGrey, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                ...
                <Typography variant="h6" component="div" sx={{ flexGrow: 1, textAlign: 'right', fontFamily: 'Fira Code', color: customColors.primaryYellow, textTransform: 'uppercase' }}>
                    Mathieu Bon
                </Typography>
            </Toolbar>
