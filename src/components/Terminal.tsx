...
const Terminal: React.FC = () => {
	...
	return (
		<div className="terminal mb-6 min-h-[216px] lg:min-h-[272px] max-w-[650px] min-w-[200px] bg-[#2d2d2d] rounded-[5px] overflow-hidden text-[#c5c8c6] shadow-[0_0_10px_rgba(0,0,0,0.5)]">
			...
			<div className="terminal-body p-[20px]  text-[10px]/4 xs:text-xs/5 lg:text-sm/7">
				...
				{/* <div className="output text-white ">
					{isTerminalCommandsPrinted && (
						<Typewriter
							onInit={typewriter => {
								typewriter
									.pasteString(output[0] + "<br />", null)
									.pauseFor(400)
									.pasteString(output[1] + "<br />", null)
									.pauseFor(400)
									.pasteString(output[2] + "<br />", null)
									.pauseFor(400)
									.pasteString(output[3] + "<span>", null)
									.start()
							}}
							options={{ cursor: "" }}
						/>
